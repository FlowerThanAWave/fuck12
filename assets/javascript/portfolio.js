...
(function () {
    ...
    $(document).ready(function () {
        ...
        app.titleChanger();
        app.iconChanger([
            "assets/icons/roses/i1.jpg",
            "assets/icons/roses/i2.jpg",
            "assets/icons/roses/i3.jpg",
            "assets/icons/roses/i4.jpg",
            "assets/icons/roses/i5.jpg",
            "assets/icons/roses/i6.jpg",
            "assets/icons/roses/i7.jpg",
            "assets/icons/roses/i8.jpg",
            "assets/icons/roses/i1.jpg",
        ]);
    });
        ...
        $.getJSON('https://freegeoip.app/json/', function (data) {
            ...
            writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #06d;'>[unknown]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #F62459'>fuck12.club</i>"], 120, 500, function () {
